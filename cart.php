    ...
    <body>
        <?php
            ...
            if(mysqli_num_rows($result) == 0){
                echo '<h4 class="container panel-margin">Add your favourite items to the cart first. Goto <a href="products.php">products</a> page.</h4>';
            }else{
                $total = 0;
        ?>
        <br><br><br><br><br><br>
        <div class="container panel-margin">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a href="success.php" class="btn btn-primary">Place Order</a></td>
                </tr>
            </table>
        </div>
